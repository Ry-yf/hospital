...
import store from '../../store';
	export default {
		data() {
			return {
				team:require("../../static/team.jpg"),
				physicianTeam:[
					{
						name:'文医师',
						image:require("../../static/wen.jpg"),
						title:'口腔治疗专科医师'
					},
					{
						name:'刘医师',
						image:require("../../static/liu.jpg"),
						title:'口腔全科医师'
					},
					{
						name:'朱护士',
						image:require("../../static/zhu.jpg"),
						title:'口腔执业护士'
					}
				],
				form: {
		...
		methods: {
			...
			submit() {
				this.$refs.uForm.validate(valid => {
					if (valid) {
						store.commit('addorder',{status:'待支付',img:require('../../static/3dci.jpg'),orderId:this.$store.getters.getorderId,projectName:this.form.project,price:50,number:1})
						console.log(this.form.project);
					} else {
						console.log("验证不通过")
					}
