			...
			submit() {
				...
				this.$refs.uForm.validate(valid => {
					if (valid) {
						...
						// this.$data.store.commit('addorder',{status:'待支付',img:require('../../static/3dci.jpg'),orderId:this.$data.get,projectName:this.$data.detail.title,price:this.$dada.detail.price,number:this.$data.form.number})
						// store.commit('addorder',{status:'待支付',img:require('../../static/3dci.jpg'),orderId:this.orderId,projectName:this.$data.detail.title,price:this.$dada.detail.price,number:this.$data.form.number})
